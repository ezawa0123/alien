...
def check_keydown_events(event, ai_settings, screen, ship, sb, stats, bullets, aliens):
    ...
    if event.key == pygame.K_p:
        start_game(stats, aliens, bullets, ship, sb, screen, ai_settings)
...
def check_events( ai_settings, screen, stats, sb, play_button, ship, aliens, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_keydown_events(event, ai_settings, screen, ship, sb, stats, bullets, aliens)
...
def start_game(stats, aliens, bullets, ship, sb, screen, ai_settings):
